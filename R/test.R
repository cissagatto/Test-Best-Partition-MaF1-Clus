cat("\n\n##############################################################")
cat("\n# START TEST SELECTED BEST MACRO F1 PARTITION                  #")
cat("\n################################################################\n\n") 
...
#config_file = "~/Test-Best-Partition-MaF1-Clus/T-Config-Files/jaccard/j-t-GpositiveGO.csv"
...
cat("\n# EXEXUTE                                                          #")
cat("\n####################################################################\n\n")
timeFinal <- system.time(results <- executeTBPMA(ds,
                                                dataset_name,
                                                number_dataset, 
                                                number_cores, 
                                                number_folds, 
